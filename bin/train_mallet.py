...
def TrainMallet( corpus_path, model_path, token_regex, num_topics, num_iters ):
...
def main():
	...
	TrainMallet( args.corpus_path, args.model_path, args.token_regex, args.topics, args.iters )
